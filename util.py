...
# path settings
workPath = sys.path[0]
contourFilePath = workPath + '/rData/contour.dat'
storagePath = workPath + '/jigsaw/tmpCrawlData'
...
shapeName = 'shape.png'
# file settings
ledgerPath = workPath + "/rData/ledger.txt"
...
def getToken(username, passwd):
    req = urllib2.Request('http://www.66yzm.com/api/admin/dengl/zhanghao/' + username + '/mima/' + passwd) 
